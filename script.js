function submitdetails(event) {
    ...
    axios
        .post("https://crudcrud.com/api/dc100d50776d4f21ac5140e34e0449e0/admindata", obj)
        .then((response) => {
...
window.addEventListener("DOMContentLoaded", () => {
    axios
        .get("https://crudcrud.com/api/dc100d50776d4f21ac5140e34e0449e0/admindata")
        .then((response) => {
...
function showuseronscreen(obj) {
    ...
    del.onclick = function() {
        axios
            .delete(`https://crudcrud.com/api/dc100d50776d4f21ac5140e34e0449e0/admindata/${obj._id}`)
            .then((response) => {
